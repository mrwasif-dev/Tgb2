    ...
    try {
        if (await database.isConnected()) {
            ...
            if (planDocs.length === 0) {
                ...
                const defaultPlans = [
                    { id: 'plan1', name: 'Basic Plan', price: 350, duration: 15, features: ['1 WhatsApp Link'], whatsappCount: 1 },
                    { id: 'plan2', name: 'Standard Plan', price: 500, duration: 30, features: ['1 WhatsApp Link'], whatsappCount: 1 },
                    { id: 'plan3', name: 'Premium Plan', price: 1200, duration: 90, features: ['1 WhatsApp Link'], whatsappCount: 1 },
                    { id: 'plan4', name: 'Business Plan', price: 2000, duration: 90, features: ['2 WhatsApp Links'], whatsappCount: 2 }
                ];
